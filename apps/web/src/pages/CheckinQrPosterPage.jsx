 ...
 * Visitors scan this QR with their phone camera → /checkin/CT-… → use the Tara, Cavite! app to check in.
 */
export function CheckinQrPosterPage() {
  ...
  if (!code) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-white p-6 font-['Poppins',sans-serif]">
  ...
  return (
    <div className="min-h-screen bg-white px-4 py-8 font-['Poppins',sans-serif] text-neutral-900">
      <div className="mx-auto flex max-w-lg flex-col items-center text-center print:max-w-none">
        <div className="no-print mb-6 flex w-full items-center justify-between gap-3">
          ...
          <button
            ...
            className="rounded-full bg-[#1B8A70] px-4 py-2 text-sm font-semibold text-white"
          >
            Print / Save as PDF
          </button>
        </div>

        <p className="font-['Poppins',sans-serif] text-sm font-semibold uppercase tracking-[0.14em] text-[#1B8A70]">
          Tara, Cavite! check-in
        </p>
        <h1 className="mt-2 font-['Poppins',sans-serif] text-2xl font-semibold sm:text-3xl">
          Scan to check in with the app
        </h1>
        <p className="mt-2 max-w-sm text-sm text-neutral-600">
          Use the Tara, Cavite! mobile app to count your visit. This website is for browsing and planning
          only — one visit per day is counted in the app (admin + business).
        </p>
        ...
        <p className="no-print mt-8 text-xs text-neutral-500">
          Display this poster at the entrance. Visitors should open the Tara, Cavite! app to check in.
        </p>
      </div>
