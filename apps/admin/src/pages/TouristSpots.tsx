  ...
  return (
    <div className={styles.page}>
      <div className={styles.header}>
        <div>
          <h1>{platform === 'web' ? 'Tourist Spots (Web)' : 'Places / POI (Mobile)'}</h1>
          <p>
            {platform === 'web'
              ? 'Curate spots for Search, place detail, and the web map.'
              : 'Points of interest for Map, directions, and saved lists in the app.'}
          </p>
        </div>
