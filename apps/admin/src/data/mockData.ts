...
export const trafficByCity = [
  ...
  { name: 'Dasmariñas City', value: 0.66 },
...
export const businessApplications: BusinessApplication[] = [
  ...
  { id: 'APP-2026-095', business: 'Dasma Heritage Inn', reference: '#APP-2026-095', lgu: 'Dasmariñas City', type: 'Hotel / Inn', submitted: '2 days ago', contact: 'dasmainn@example.com', status: 'under_review', flagged: false },
...
export const processedLogs: ProcessedLog[] = [
  ...
  { id: 'l6', reference: 'WAPP-2026-0085', business: 'Dasma Craft Coffee', lgu: 'Dasmariñas City', reviewedBy: 'Maria Santos', processedDate: 'Yesterday, 02:10 PM', status: 'approved' },
