-- Admin audit log: records catalog, CMS, user, and establishment writes by signed-in admins.
-- Safe to re-run.
...
COMMENT ON TABLE public.admin_audit_log IS
  'Admin action history for Analytics → Audit log (who changed what, when).';
