...
-- Mirrors supabase/ESTABLISHMENT_PORTAL.sql.
--
...
--    RLS cannot restrict columns, and owners must never touch is_listed,
--    highlight, or ntdp_category, so content writes go through this RPC.
-- ---------------------------------------------------------------------------
...
REVOKE ALL ON FUNCTION public.update_my_establishment_listing(TEXT, TEXT[], TEXT, TEXT, TEXT, TEXT, TEXT) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.update_my_establishment_listing(TEXT, TEXT[], TEXT, TEXT, TEXT, TEXT, TEXT) TO authenticated;
